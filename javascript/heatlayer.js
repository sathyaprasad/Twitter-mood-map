...
dojo.addOnLoad(function() {
  ...
  dojo.declare("modules.HeatLayer", esri.layers.Layer, {
    ...
    constructor: function(data, options) {
	  ...
	  this.id = "heatmaplayer";
      this.data = data;
	  this.pxgrid = options.pixelsSquare || 64;

	this.pattern = [
		{
			start:0,
			red:function(alpha){ return 0 },
			green:function(alpha){ return 0 },
			blue:function(alpha){ return 0 },
			alpha:function(alpha){ return Math.max(40,alpha) }
		},
		{
			start:25,
			red:function(alpha){ return 251 },
			green:function(alpha){ return 180 },
			blue:function(alpha){ return 185 },
			alpha:function(alpha){ return alpha }
		},
		{
			start:51,
			red:function(alpha){ return 247 },
			green:function(alpha){ return 104 },
			blue:function(alpha){ return 161 },
			alpha:function(alpha){ return alpha }
		},
		{
			start:75,
			red:function(alpha){ return 197 },
			green:function(alpha){ return 27 },
			blue:function(alpha){ return 138 },
			alpha:function(alpha){ return alpha }
		},
		{
			start:99,
			red:function(alpha){ return 122 },
			green:function(alpha){ return 1 },
			blue:function(alpha){ return 119 },
			alpha:function(alpha){ return alpha }
		}
	];
